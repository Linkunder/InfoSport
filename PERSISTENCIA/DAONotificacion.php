<?php
	...
	public function insertarRecinto($recinto){
		$link=$this->conexionBD->getConexion();
		$query="INSERT INTO notificacion(nombre,descripcion,precio,horario,numero_canchas,direccion,telefono,superficie)
		VALUES('".$recinto->getNombre()."','".$recinto->getDescripcion()."','".$recinto->getPrecio()."','".$recinto->getHorario()."','".$recinto->getCantidadCanchas()."','".$recinto->getDireccion()."','".$recinto->getTelefono()."','".$recinto->getSuperficie()."')";
